      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-12">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="text-center bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-100"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <Card
                key={index}
                className="overflow-hidden hover:shadow-xl transition-all duration-300 group border-0 bg-white/80 backdrop-blur-sm"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our proven project delivery methodology ensures consistent results
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                We start with thorough requirement analysis and create a
                detailed project roadmap that aligns with your business
                objectives.
              </p>
            </div>
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Our agile development process includes continuous testing and
                regular client feedback to ensure the highest quality
                deliverables.
              </p>
            </div>
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                We handle deployment and provide comprehensive support to ensure
                your solution performs optimally in production.
              </p>
            </div>
          </div>
        </div>
