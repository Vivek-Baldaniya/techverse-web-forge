...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email Us",
      details: "info@getintotechverse.com",
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Absolutely! We specialize in integrating new solutions with existing business systems."
    },
    {
      question: "What technologies do you use?",
      answer: "We use modern, industry-standard technologies including React, Node.js, Python, AWS, and more."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <CardContent className="px-8 pb-8">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="group">
                        <label htmlFor="budget" className="flex items-center text-sm font-semibold text-gray-700 mb-3">
            ...
            <div className="space-y-6">
              ...
              {contactInfo.map((info, index) => (
                <Card key={index} className="hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-r from-gray-50 to-gray-100">
              ...
              <Card className="bg-gradient-to-br from-blue-50 to-purple-50 border-0">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <Button variant="outline" className="w-full justify-start h-12 border-2 border-gray-200 text-gray-700 hover:bg-white hover:border-blue-300 transition-all duration-200">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Visit our office or schedule a virtual meeting</p>
          </div>
